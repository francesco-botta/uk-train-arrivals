# UK Railway Station CRS codes to full names mapping
# Source: https://github.com/davwheat/uk-railway-stations
# Official list of stations queryable through National Rail Darwin API
# Total: 2599 stations
...
def get_station_name(crs_code):
    """Get full station name from CRS code."""
    if not crs_code:
        return ""
    return STATIONS.get(crs_code.upper(), crs_code)
...
def search_stations(query):
    ...
    return sorted(results, key=lambda x: x["name"])[:20]
